...
def main(args):
    ...
    for cancer in cancer_type_list:
        ...
        X_train, X_val, X_test, Y_train, Y_val, Y_test, meta_test, meta_val = prepare_data_for_model(data_query_cancer)
        if args.model == 'all':
...
if __name__ == "__main__":
    ...
    parser.add_argument('--atype', type=str, required=True, help="analysis type")        
